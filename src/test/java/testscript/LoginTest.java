...
public class LoginTest extends  Base{
	...
	public void verifyLoginWithaInvalidUsernameAndValidPassword() throws IOException {
		String username = ExcelUtilities.getStringData(2, 0, "loginsheet");
		String password = ExcelUtilities.getStringData(2, 1, "loginsheet");
	...
	public void verifyLoginWithValidUsernameAndInvalidPassword() throws IOException {
		...
		String username = ExcelUtilities.getStringData(3, 0, "loginsheet");
		String password = ExcelUtilities.getStringData(3, 1, "loginsheet");
	...
	{
		String username = ExcelUtilities.getStringData(4, 0, "loginsheet");
		String password = ExcelUtilities.getStringData(4, 1, "loginsheet");
		LoginPage login = new LoginPage(driver);
		//login.enterUserNameonUsernameField(username);
		//login.enterPasswordinPasswordField(password);
		login.enterUserNameonUsernameField(username).enterPasswordinPasswordField(password);
